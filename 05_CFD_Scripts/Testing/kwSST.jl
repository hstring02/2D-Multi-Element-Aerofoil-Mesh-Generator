...
grids_dir = pkgdir(XCALibre, raw"C:\Users\Harry\OneDrive\1 - Documents\6 - Projects, Schemes and Learning\01_2D_Airfoil_Simulator\V3\04_Meshes")
grid = "2_element_wing.unv"
...
model = Physics(
    ...
    turbulence = RANS{KOmegaSST}(walls=(:airfoil,)),
