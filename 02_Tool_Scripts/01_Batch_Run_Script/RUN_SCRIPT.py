...
runs_dir = REPO_ROOT / "01_Input_Files" / "Batch" / batch_name
results_dir = REPO_ROOT / "05_CFD_Results" / batch_name
...
try:
    for i, value in enumerate(sweep_values):
        ...
        # (see 02_Tool_Scripts/03_CFD_Scripts/cfd_worker.jl). If it has died, further
